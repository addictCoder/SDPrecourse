public class RandomNumbers
{
	public static void main(String[] args)
	{
		...
		//////////////////////////////////////////////Study Drills/////////////////////////////////////////////////////
		// Pick three random ints, 1-3
		System.out.println("1-3:\t" + (int)(1 + (3 * Math.random())) + "\t" + (int)(1 + (3 * Math.random())) + "\t" + (int)(1 + (3 * Math.random())) + "\t");
		// Pick three random ints, 5-10
